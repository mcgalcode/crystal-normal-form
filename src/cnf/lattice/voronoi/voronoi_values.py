...
from .constants import CONORM_IDX_TO_PAIR, CONORM_PAIRS_TO_IDXS
...
class Conorm(VoronoiValue):
    ...
    def from_idx(cls, idx):
        if idx not in CONORM_IDX_TO_PAIR:
            raise ValueError(f"Tried to instantiate conorm with out-of-range idx {idx}")
        return cls(CONORM_IDX_TO_PAIR[idx])
